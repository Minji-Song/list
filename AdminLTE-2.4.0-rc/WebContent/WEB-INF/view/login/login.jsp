   ...
   <div class="login-box">
      ...
      <div class="login-box-body">
         <p class="login-box-msg">Sign in to start your session</p>
			...
			<c:if test="${errors.idOrPwNotMatch}"><script>alert("이메일 혹은 비밀번호를 다시 확인하세요.");</script></c:if>
            <div class="form-group has-feedback">
               <input type="email" class="form-control" name="id" id="email" placeholder="Email"  value="${param.id}">
         ...
         <a href="#">I forgot my password</a><br> <a href="join.do" class="text-center">Register a new membership</a>
